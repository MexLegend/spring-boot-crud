package com.crud.crudmongoddb.global.exceptions;

import com.crud.crudmongoddb.global.dto.MessageDto;
import com.crud.crudmongoddb.global.utils.Operations;
...
public class GlobalException {
    ...
    public ResponseEntity<MessageDto> validationException(MethodArgumentNotValidException e) {
        ...
        return ResponseEntity.badRequest().body(new MessageDto(HttpStatus.BAD_REQUEST, Operations.StrimBrackets(messages.toString())));
    }
}
